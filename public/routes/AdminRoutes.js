...
router.post("/add-testimonial-text", TestimonialTextController.AddTestimonialText);
router.get("/get-testimonial-text/:id", TestimonialTextController.GetTestimonialTextById);
router.put("/edit-testimonial-text/:id", TestimonialTextController.UpdateTestimonialText);
...
router.post("/add-our-team", OurTeamController.AddOurTeam);
router.get("/get-our-team/:id", OurTeamController.GetOurTeamById);
router.put("/edit-our-team/:id", OurTeamController.UpdateOurTeam);
